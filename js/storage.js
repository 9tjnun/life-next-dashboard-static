...
LN.exportBackupObject = () => {
  ...
  return {
    version: "v11.7-calendar-backup-seasonal",
    exportedAt: new Date().toISOString(),
    note: "Life Next Dashboard data backup: Facebook, YouTube, Product records, Calendar done state, and raw Life Next localStorage keys.",
