...
LN.weeklyTemplate = [
  ...
  { dayIndex: 2, day: "อังคาร", focus: "Wall Art + Stock Check", morning: "ทำ wall art / mockup / SEO / เติม stock งานหลัก", night: "ลง Etsy 5 listings + จด record", tasks: [...dailyCore] },
  ...
  { dayIndex: 4, day: "พฤหัส", focus: "Planner / Checklist", morning: "เช็กงาน planner / checklist แบบสะสม stock ถ้ามีแรง", night: "ลง Etsy 5 listings + บันทึก record", tasks: [...dailyCore] },
  { dayIndex: 5, day: "ศุกร์", focus: "QA + Shorts", morning: "ตรวจไฟล์ SEO mockup listing package", night: "ลง Shorts 1 คลิป + Etsy 5 listings", tasks: [...dailyCore, { id: "youtube-short", platform: "youtube", title: "YouTube Short / Reels", detail: "ลง Shorts 1 คลิป และกระจายลง Reels" }] },
  { dayIndex: 6, day: "เสาร์", focus: "Batch + Distribute", morning: "งานเบา / จัด Pinterest batch ถ้ามีแรง", night: "ลง Etsy 5 listings + Facebook post", tasks: [...dailyCore] },
  { dayIndex: 0, day: "อาทิตย์", focus: "Review + Scheduled Publish Slots", morning: "รีวิวสัปดาห์ / เติม stock ที่ใกล้หมด / เช็กงานรอบอาทิตย์", night: "เตรียมแผนสัปดาห์หน้า + Etsy 5 listings", tasks: [...dailyCore, { id: "youtube-short", platform: "youtube", title: "YouTube Short / Reels", detail: "ลง Shorts หรือเตรียมคลิปสัปดาห์หน้า" }] }
];
LN.seasonalGuide = [
